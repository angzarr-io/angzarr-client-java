...
public class QueryClientSteps {
  ...
  public void anAggregateWithRootHasEventWithData(
      String domain, String root, String eventType, String data) {
    this.domain = domain;
    this.rootId = root;
    this.eventCount = 1;
    this.nextSequence = 1;
  ...
  public void anAggregateWithRootHasEventsInEdition(
      String domain, String root, int count, String edition) {
  ...
  @Given(
      "an aggregate {string} with root {string} has a snapshot at sequence {int} and {int} events")
  public void anAggregateWithRootHasSnapshotAndEvents(
      String domain, String root, int snapshotSeq, int count) {
    this.domain = domain;
    this.rootId = root;
    this.eventCount = count;
    this.nextSequence = count;
  ...
  public void iQueryEventsFromSequenceToSequence(
      String domain, String root, int fromSeq, int toSeq) {
    this.domain = domain;
    this.rootId = root;
    this.queryFromSequence = fromSeq;
