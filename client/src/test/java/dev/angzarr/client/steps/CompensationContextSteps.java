 ...
 *
 * <p>Tests extraction of rejection details and notification building. These are unit tests that
 * don't require a running gRPC server.
 */
public class CompensationContextSteps {
  ...
  public void aCommandRejectedWithStructuredReason() {
    commandRejected = true;
    rejectionReason =
        "{\"code\": \"INSUFFICIENT_FUNDS\", \"details\": {\"required\": 100, \"available\": 50}}";
  }
