...
public class FactFlowSteps {
  ...
  public void anActionRequestedFactIsInjected() {
    ...
    playerAggregate.nextSequence++;
    factInjected =
        new MockFact("player", playerAggregate.rootId, "fact-1", UUID.randomUUID().toString());
  }
  ...
  public void playerAggregateEmitsPlayerSittingOut(String name) {
    if (tableAggregate != null) {
      ...
      factInjected =
          new MockFact("table", tableAggregate.rootId, "fact-1", UUID.randomUUID().toString());
    }
  }
  ...
  public void theSagaProcessesAnEvent() {
    if (saga != null) {
      if ("nonexistent".equals(saga.targetDomain)) {
        ...
        factInjected =
            new MockFact(
                saga.targetDomain, UUID.randomUUID(), "fact-1", UUID.randomUUID().toString());
      }
    }
  }
