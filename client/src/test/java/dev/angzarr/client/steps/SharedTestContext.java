 ...
 *
 * <p>This class holds state that needs to be shared across multiple step definition files within a
 * single scenario. Cucumber's PicoContainer DI automatically creates and injects a single instance
 * per scenario.
 */
