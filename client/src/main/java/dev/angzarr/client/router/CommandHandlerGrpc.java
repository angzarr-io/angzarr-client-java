 ...
 *
 * <p>Implements {@code CommandHandlerService.handle} by delegating to the router's {@link
 * CommandHandlerRouter#dispatch(ContextualCommand)}. {@code handleFact} and {@code replay} fall
 * through to the generated default ({@code UNIMPLEMENTED}) — add overrides in a subclass if your
