 ...
 *
 * <p>{@code handle} delegates to the router. PMs translate trigger events plus their own state into
 * commands/facts and rely on destination_sequences for command stamping.
 *
