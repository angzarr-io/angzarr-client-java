 ...
 *
 * <ul>
 *   <li>State reconstruction - rebuild aggregate state from events
 *   <li>Audit trails - read complete history for compliance
 *   <li>Projections - feed events to read-model projectors
 *   <li>Testing - verify events were persisted after commands
 * </ul>
 *
 * <p>Usage:
 *
