 ...
 *
 * <ul>
 *   <li>Emit events (EventBook) - to fix/retry/compensate state
 *   <li>Emit notification upstream - to forward rejection to originating component
 *   <li>Both - compensate locally AND notify upstream
 * </ul>
 */
